...
public:
    ...
    void create(QGraphicsScene* const scene) {
        ...
        b2PrismaticJoint* h_joint = (b2PrismaticJoint*) CreateJoint(&hor_joint_def);
        ...
        b2PrismaticJoint* v_joint = (b2PrismaticJoint*) CreateJoint(&vert_joint_def);
